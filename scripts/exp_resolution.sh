...
# 256 já existe (models/exp_widefield2, 16-128/widefield2). Este script treina 384 e 512.
set -e
ROOT="$(cd "$(dirname "$0")/.." && pwd)"; cd "$ROOT"
VENV="$ROOT/.venv/bin/python"
DR="data/starter_kit/app_ingestion/input_data/train"

for RES in 384 512; do
...
for PAIR in "256:models/exp_widefield2" "384:models/exp_res384" "512:models/exp_res512"; do
